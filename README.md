...
Требуются чистый Ubuntu 22.04+, root-доступ и домен с единственной A-записью на IPv4 VPS. SSH-ключ нужен только при выборе key-only режима. AAAA-записи быть не должно.
