...
- Показать текущие настройки: пункт `5` в меню — появляется после завершённой установки.
- Продолжить прерванную настройку: `/root/finish-xhttp-vps.sh`
- Удалить установку: пункт `3` в меню.
- Подготовить VPS к новой установке: пункт `4` в меню.
