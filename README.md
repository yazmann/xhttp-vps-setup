...
- Внешний firewall разрешает SSH, TCP/80, TCP/443 и случайный порт панели, который покажет установщик
...
Репозиторий приватный. Клонируйте или скачайте его через GitHub Desktop, затем загрузите **оба** файла в `/root` VPS: `install-xhttp-vps.sh` и `finish-xhttp-vps.sh`.
...
Если основной установщик дошёл до установки 3x-ui, но прервался во время настройки, запустите заранее загруженный вместе с ним файл:
